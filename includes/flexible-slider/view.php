	...
	*/
	function edit_form()
	{
		...
		<form action="?page=flexibleslider_save" method="post">
											...
											?>
												...
												?>
													<li class="ui-state-default"> <!-- sortable element -->
														<img src='<?php echo get_stylesheet_directory_uri(); ?>/includes/flexible-slider/images/<?php echo $item->id . '/thumb/' . $image?>' />
			...
			<input type="hidden" id="url"    name="url"    value="<?php echo get_stylesheet_directory_uri(); ?>/includes/flexible-slider/" />
