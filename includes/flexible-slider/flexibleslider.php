...
class flexibleslider
{
	...
	{
		wp_enqueue_style( 'fslider-jquery-ui-style', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/jquery-ui.css' );
		wp_enqueue_style( 'fslider-style', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/style.css', array('fslider-jquery-ui-style') );
		
		if($hook == 'toplevel_page_flexibleslider')
		{
			wp_enqueue_script( 'fslider-jquery-bgiframe', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/jquery.bgiframe-2.1.2.js', array('jquery', 'jquery-ui-core', 'jquery-ui-dialog') );
			wp_enqueue_script( 'fslider-list', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/list.js', array('jquery') );
		}
		else if($hook == 'admin_page_flexibleslider_edit')
		{
			wp_enqueue_script( 'fslider-jquery-bgiframe',  get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/jquery.bgiframe-2.1.2.js', array('jquery', 'jquery-ui-core', 'jquery-ui-dialog', 'jquery-ui-sortable') );
			wp_enqueue_script( 'fslider-plupload', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/plupload.js', array('jquery') );
			
			if(!$_GET['id'])	{
				wp_enqueue_script( 'fslider-detail', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/detail.js', array('jquery', 'fslider-plupload') );
			} else {
				wp_enqueue_script( 'fslider-plupload-html5', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/plupload.html5.js', array('jquery', 'fslider-plupload') );
				wp_enqueue_script( 'fslider-plupload-flash', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/plupload.flash.js', array('jquery', 'fslider-plupload') );
				wp_enqueue_script( 'fslider-detail', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/detail.js', array('jquery', 'fslider-plupload', 'fslider-plupload-html5', 'fslider-plupload-flash') );
			}
	...
	{
		wp_enqueue_script( 'fslider-jquery-easing', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/jquery.easing-1.3.js', array('jquery') );
		wp_enqueue_script( 'fslider-slider', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/slider.js', array('jquery', 'fslider-jquery-easing') );
		wp_enqueue_style( 'style-4', get_stylesheet_directory_uri() . '/includes/flexible-slider/assets/style-4.css' );
	}
