...
<?php if ( 'on' == et_get_option('flexible_featured', 'on') && is_home() ) get_template_part( 'includes/featured', 'home' ); ?>
	...
	<div id="slideshow" align="right">
		<a href="http://www.deolhonoplano.org.br/saopaulo/wp-content/themes/Flexible/images/teste.jpg"><img src="http://www.deolhonoplano.org.br/saopaulo/wp-content/themes/Flexible/images/teste.jpg" /></a>
	</div>
...
<iframe width="300" height="200" src="//www.youtube.com/embed/NkU_8pD4J3E?list=UUb1B3xj33Aser_ZzRHWy2EQ" frameborder="0" allowfullscreen></iframe>
</div>

<div id="botoes" align="center">
<a href="http://www.deolhonoplano.org.br/saopaulo/wp-content/themes/Flexible/images/teste_mapa.jpg"><img src="http://www.deolhonoplano.org.br/saopaulo/wp-content/themes/Flexible/images/teste_mapa.jpg" /></a>
</div>

<div id="botoes" align="center">
<iframe width="300" height="200" src="//www.youtube.com/embed/r3rocE-rtBI?list=UUb1B3xj33Aser_ZzRHWy2EQ" frameborder="0" allowfullscreen></iframe>
</div>
...
<?php if ( 'on' == et_get_option('flexible_display_recentwork_section','on') ) { ?>
	<section id="portfolio" class="clearfix">
		<h2 class="section-title" align="center"><?php esc_html_e( 'Conhe&ccedil;a o processo de elabora&ccedil;&atilde;o do Plano Municipal de Educa&ccedil;&atilde;o da Cidade de S&atilde;o Paulo', 'Flexible' ); ?></h2>
...
<?php if ( 'on' == et_get_option('flexible_display_fromblog_section','on') && ( 'false' == et_get_option('flexible_blog_style','false') ) ) { ?>
	<section id="blog" class="clearfix">
		...
		<a href="<?php echo esc_url( et_get_option( 'flexible_more_posts_url', '#' ) ); ?>" class="more"><?php esc_html_e( 'Leia mais &raquo;', 'Flexible' ); ?></a>
